...
@Component({
  ...
  template: `
    <div class="mx-auto max-w-5xl">
      ...
      @if (showtimesResource.isLoading()) {
      ...
      } @else if (showtimesResource.error()) {
        ...
        <div class="space-y-6">
          @for (group of groups(); track group.movie.id) {
              ...
              <div class="flex items-center gap-4 border-b border-slate-100 p-4">
                ...
                <div>
                  <a
                    ...
                    [routerLink]="['/home/movies', group.movie.id]"
                  >
                    {{ group.movie.title }}
                  </a>
                  <p class="text-xs text-slate-500">{{ group.movie.duration_minutes }} min</p>
                </div>
              </div>
